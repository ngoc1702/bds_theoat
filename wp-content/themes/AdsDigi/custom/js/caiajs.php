...
//    var widgets = $('.lydo2 .widget');

//   // Ẩn tất cả .textwidget và bỏ class active
//   widgets.find('.textwidget').hide();
//   widgets.find('.widget-title').removeClass('active');

//   // Mặc định hiện widget đầu tiên
//   widgets.first().find('.widget-title').addClass('active');
//   widgets.first().find('.textwidget').show();

//   // Bắt sự kiện click
//   widgets.find('.widget-title').click(function() {
//     var $title = $(this);
//     var $widget = $title.closest('.widget');

//     // Ẩn tất cả và remove class
//     widgets.find('.textwidget').slideUp();
//     widgets.find('.widgettitle').removeClass('active');

//     // Hiện cái được click
//     $widget.find('.textwidget').slideDown();

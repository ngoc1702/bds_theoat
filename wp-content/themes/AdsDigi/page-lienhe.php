...
function caia_add_lienhe(){
	...
	echo '<div data-aos="fade-up" class="content-lienhe section">';
				echo '<div class="lienhe">';
						echo '<h1>' . get_the_title() . '<span> ADSDIGI</span></h1>';
						// echo '<h1>Liên hệ <span>ADSDIGI</span></h1>';
						the_content();
				echo '</div>';
				echo '<div class="lienhe">';
...
function caia_add_map(){
	global $post;
   echo '<div data-aos="fade-up" class="contact-section section">';
			echo rwmb_meta('nd');
			echo '</div>';
...
// add_action('genesis_before_footer','caia_add_content_after_footer');
